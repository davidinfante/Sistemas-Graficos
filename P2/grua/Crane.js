...
class Crane extends THREE.Object3D {
  ...
  constructor (/*parameters*/aMaterial) {
    ...
    this.craneHeight = /*(parameters.craneHeight === undefined ? 30 : parameters.craneHeight)*/30;
    this.craneWidth  = /*(parameters.craneWidth === undefined ? 45 : parameters.craneWidth)*/45;
  ...
  createTrolleyStringHook () {
    ...
    //Thinner string
    //-----------------
    this.string.scale.x = 0.3;
    this.string.scale.z = 0.3;
  ...
  //Disengage box
  //-----------------
  /// The crane has a box taken
  /**
    * @return If the crane has engaged a box.
    */
  getEngagedBox () {
    return this.engagedBox;
  }
